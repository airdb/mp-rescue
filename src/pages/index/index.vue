<template>
  ...
  <view class="lost-list-container">
    ...
    <!--List of lost info-->
    <view class="content">
      <content-item v-for="item in list" :key="item.id" :item="item" />
    </view>
  </view>
</template>
...
export default {
  ...
  setup() {
    const { query, list, loadList, refreshList } = useList({
      url: API_LIST.lost,
      queryDefault: { category: 1 },
    });
    const background = [
      "https://wechat-1251018873.file.myqcloud.com/mp-rescue/images/banner.jpg",
      "https://wechat-1251018873.file.myqcloud.com/mp-rescue/images/banner.jpg",
      "https://wechat-1251018873.file.myqcloud.com/mp-rescue/images/banner.jpg",
    ];
